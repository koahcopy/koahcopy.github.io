...
(function ($) {
	...
	setTimeout(function() {
		Swal.fire({
			...
			width: '30rem',
			padding: '5%',
			html: '<h2>Did someone say free copy?</h2><p>If you\'re new to Koah, we can offer you a free piece of copy of your choosing to show you what we\'re made of.</p><p>Sign up below and we\'ll be in touch.</p><a href="mailto:info@koahcopy.co.uk?subject=Yes I would like free copy" class="tp-btn w-100">Yes please</a>',
		  })
	}, delayInMilliseconds);
